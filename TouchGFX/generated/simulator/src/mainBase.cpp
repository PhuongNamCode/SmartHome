...
const uint8_t* video_video2_216x216_bin_start;
...
void setupVideoDecoder(touchgfx::HAL& hal)
{
    ...
    setupVideo(static_cast<touchgfx::HALSDL2&>(hal).localFileName(videoFileName, 400, "video2_216x216.bin"), &video_video2_216x216_bin_start, video_video2_216x216_bin_length);
}
...
void setupSimulator(int argc, char** argv, touchgfx::HAL& hal)
{
    ...
    static_cast<touchgfx::HALSDL2&>(hal).setWindowTitle("SmartHome_V2");
